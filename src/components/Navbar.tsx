...
const Buttons = [
  ...
  },
  {
    ...
    content: <><svg className='mr-4' width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M0.412598 14.5626C0.412598 14.1346 0.759577 13.7876 1.1876 13.7876H16.8126C17.2406 13.7876 17.5876 14.1346 17.5876 14.5626C17.5876 14.9906 17.2406 15.3376 16.8126 15.3376H1.1876C0.759577 15.3376 0.412598 14.9906 0.412598 14.5626Z" fill="white" />
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M10.4126 1.4376C10.4126 1.00958 10.7596 0.662598 11.1876 0.662598H15.5626C15.9906 0.662598 16.3376 1.00958 16.3376 1.4376V14.5626C16.3376 14.9906 15.9906 15.3376 15.5626 15.3376H11.1876C10.7596 15.3376 10.4126 14.9906 10.4126 14.5626V1.4376ZM11.9626 2.2126V13.7876H14.7876V2.2126H11.9626Z" fill="white" />
    </svg>
      Analytics </>,
  },
  {
  ...
  return (
    <div className="flex flex-col relative min-h-full">
      ...
      <div className="flex flex-col items-start justify-center mt-5 opacity-80 text-whiteBg">
        {Buttons.map((btn) => {
          return (
            <button className='text-sm flex items-center leading-5 my-2 py-2 px-4 w-full hover:bg-gray-500 rounded-lg bg-opacity-50'>
              {btn.content}
            </button>
          )
        })}
